...
export const metadata:Metadata={title:{default:"tierisch-verliebt.de – Singles, Tierwelten & Magazin",template:"%s | tierisch-verliebt.de"},description:"Tierliebe Singles, regionale Partnersuche und ein Magazin für Menschen, bei denen Tiere zur Familie gehören.",metadataBase:new URL("https://tierisch-verliebt.de"),icons:{icon:staticAsset("/brand/icon.png"),apple:staticAsset("/brand/apple-icon.png")}};
