...
export function MagazineHubGrid({ links, entries, title, emoji }: Props) {
    ...
    <section className="hub-grid-section" aria-labelledby="hub-grid-titel">
      ...
      <div className="hub-grid">
        {tiles.map((tile, index) => {
          ...
          return (
            <article key={tile.slug} className="hub-tile" id={firstOfLetter ? `hub-${tile.letter.toLowerCase()}` : undefined}>
